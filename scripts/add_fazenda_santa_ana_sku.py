#!/usr/bin/env python3
"""
Script to add Fazenda Santa Ana ceremonial cacao product to "Agroverse SKUs" Google Sheet
"""
...
NEW_PRODUCT = {
    ...
    'Product Name': 'Ceremonial Cacao – Fazenda Santa Ana, Bahia Brazil, 2023 (200g)',
    'Price (USD)': 25.00,
    'Weight (oz)': 7.05,
    'Category': 'retail',
    'Shipment': 'AGL2',
...
if __name__ == '__main__':
    print("=" * 60)
    print("Adding Fazenda Santa Ana Product to Agroverse SKUs Sheet")
    print("=" * 60)
    print()
